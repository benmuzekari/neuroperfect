...
function initialize_stim_and_key_variablesRoutineBegin(snapshot) {
  return function () {
    ...
    initialize_stim_and_key_variablesComponents.forEach( function(thisComponent) {
...
function get_emailRoutineBegin(snapshot) {
  return function () {
    ...
    get_emailComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function welcome_slideRoutineBegin(snapshot) {
  return function () {
    ...
    welcome_slideComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_hu_directionsRoutineBegin(snapshot) {
  return function () {
    ...
    SAM_hu_directionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_hu_questionRoutineBegin(snapshot) {
  return function () {
    ...
    SAM_hu_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function highlight_sam_hu_pre_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    highlight_sam_hu_pre_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_ec_directionsRoutineBegin(snapshot) {
  return function () {
    ...
    SAM_ec_directionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_ec_questionRoutineBegin(snapshot) {
  return function () {
    ...
    SAM_ec_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function highlight_sam_ec_pre_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    highlight_sam_ec_pre_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function introduce_keyboard_hand_positioningRoutineBegin(snapshot) {
  return function () {
    ...
    introduce_keyboard_hand_positioningComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function begin_instructionsRoutineBegin(snapshot) {
  return function () {
    ...
    begin_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_beginRoutineBegin(snapshot) {
  return function () {
    ...
    continue_beginComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function slide_max_pointsRoutineBegin(snapshot) {
  return function () {
    ...
    slide_max_pointsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fractal_selection_quizRoutineBegin(snapshot) {
  return function () {
    ...
    fractal_selection_quizComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fractal_reminder_showRoutineBegin(snapshot) {
  return function () {
    ...
    fractal_reminder_showComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function draw_slide_3RoutineBegin(snapshot) {
  return function () {
    ...
    draw_slide_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function display_feedback_meaningsRoutineBegin(snapshot) {
  return function () {
    ...
    display_feedback_meaningsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_first_questionRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_first_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_first_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_first_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_second_questionRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_second_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_second_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_second_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_third_questionRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_third_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function first_quiz_third_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    first_quiz_third_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function total_reminder_oneRoutineBegin(snapshot) {
  return function () {
    ...
    total_reminder_oneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_instructions_8_01RoutineBegin(snapshot) {
  return function () {
    ...
    continue_instructions_8_01Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_instructions_8_02RoutineBegin(snapshot) {
  return function () {
    ...
    continue_instructions_8_02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_instructions_8_03RoutineBegin(snapshot) {
  return function () {
    ...
    continue_instructions_8_03Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function feedback_selection_quizRoutineBegin(snapshot) {
  return function () {
    ...
    feedback_selection_quizComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function feedback_post_quiz_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    feedback_post_quiz_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_slide_09_01RoutineBegin(snapshot) {
  return function () {
    ...
    continue_slide_09_01Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_slide_09_02RoutineBegin(snapshot) {
  return function () {
    ...
    continue_slide_09_02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_slide_10_01RoutineBegin(snapshot) {
  return function () {
    ...
    continue_slide_10_01Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_slide_10_02RoutineBegin(snapshot) {
  return function () {
    ...
    continue_slide_10_02Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function attention_shape_checkRoutineBegin(snapshot) {
  return function () {
    ...
    attention_shape_checkComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function attention_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    attention_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_instructions_even_further_11RoutineBegin(snapshot) {
  return function () {
    ...
    continue_instructions_even_further_11Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function calib_oneRoutineBegin(snapshot) {
  return function () {
    ...
    calib_oneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function calib_lastRoutineBegin(snapshot) {
  return function () {
    ...
    calib_lastComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function advance_to_practice_sessionRoutineBegin(snapshot) {
  return function () {
    ...
    advance_to_practice_sessionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function no_feedback_work_trialLoopBegin(no_feedback_work_trialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  no_feedback_work_trial.forEach(function() {
...
function feedback_work_trialLoopBegin(feedback_work_trialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  feedback_work_trial.forEach(function() {
...
function no_loop_highlightLoopBegin(no_loop_highlightLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  no_loop_highlight.forEach(function() {
...
function yes_loop_highlightLoopBegin(yes_loop_highlightLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  yes_loop_highlight.forEach(function() {
...
function missed_trial_main_taskLoopBegin(missed_trial_main_taskLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  missed_trial_main_task.forEach(function() {
...
function no_feedback_work_trial_mainLoopBegin(no_feedback_work_trial_mainLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  no_feedback_work_trial_main.forEach(function() {
...
function feedback_work_trial_mainLoopBegin(feedback_work_trial_mainLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  feedback_work_trial_main.forEach(function() {
...
function no_loop_highlight_mainLoopBegin(no_loop_highlight_mainLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  no_loop_highlight_main.forEach(function() {
...
function yes_loop_highlight_mainLoopBegin(yes_loop_highlight_mainLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  yes_loop_highlight_main.forEach(function() {
...
function practice_taskRoutineBegin(snapshot) {
  return function () {
    ...
    practice_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function isi_screenRoutineBegin(snapshot) {
  return function () {
    ...
    isi_screenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function missed_trial_logicRoutineBegin(snapshot) {
  return function () {
    ...
    missed_trial_logicComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function no_feedback_work_logicRoutineBegin(snapshot) {
  return function () {
    ...
    no_feedback_work_logicComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function grey_work_for_fbRoutineBegin(snapshot) {
  return function () {
    ...
    grey_work_for_fbComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ask_want_to_work_for_feedbackRoutineBegin(snapshot) {
  return function () {
    ...
    ask_want_to_work_for_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function no_fb_highlightRoutineBegin(snapshot) {
  return function () {
    ...
    no_fb_highlightComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function yes_fb_highlightRoutineBegin(snapshot) {
  return function () {
    ...
    yes_fb_highlightComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fb_work_timeRoutineBegin(snapshot) {
  return function () {
    ...
    fb_work_timeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function draw_feedback_to_screenRoutineBegin(snapshot) {
  return function () {
    ...
    draw_feedback_to_screenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function post_work_blankRoutineBegin(snapshot) {
  return function () {
    ...
    post_work_blankComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function end_loop_data_logRoutineBegin(snapshot) {
  return function () {
    ...
    end_loop_data_logComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function blank_screen_2RoutineBegin(snapshot) {
  return function () {
    ...
    blank_screen_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quizRoutineBegin(snapshot) {
  return function () {
    ...
    second_quizComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_first_questionRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_first_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_first_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_first_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_second_questionRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_second_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_second_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_second_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_third_questionRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_third_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function second_quiz_third_question_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    second_quiz_third_question_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function last_stim_reminderRoutineBegin(snapshot) {
  return function () {
    ...
    last_stim_reminderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function advance_to_main_taskRoutineBegin(snapshot) {
  return function () {
    ...
    advance_to_main_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function completed_main_taskRoutineBegin(snapshot) {
  return function () {
    ...
    completed_main_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function continue_to_fractal_questionRoutineBegin(snapshot) {
  return function () {
    ...
    continue_to_fractal_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function post_task_fractal_questionRoutineBegin(snapshot) {
  return function () {
    ...
    post_task_fractal_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_hu_question_2RoutineBegin(snapshot) {
  return function () {
    ...
    SAM_hu_question_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function highlight_post_sam_huRoutineBegin(snapshot) {
  return function () {
    ...
    highlight_post_sam_huComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function SAM_ec_question_2RoutineBegin(snapshot) {
  return function () {
    ...
    SAM_ec_question_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function highlight_sam_ec_post_choiceRoutineBegin(snapshot) {
  return function () {
    ...
    highlight_sam_ec_post_choiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function total_points_end_experimentRoutineBegin(snapshot) {
  return function () {
    ...
    total_points_end_experimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
